 ...
 * @author fuhuiyuan
 */
public class RequestPlayerAnimationInfoRequest extends ProtoRequest {

	private REQUEST_PLAYER_ANIMATION_INFO requestPlayerAnimationInfo;

	public RequestPlayerAnimationInfoRequest(int receiveMessageId, byte[] datas, ISender sender, String sessionId, REQUEST_PLAYER_ANIMATION_INFO requestPlayerAnimationInfo) {
		super(receiveMessageId, datas, sender, sessionId);
		this.requestPlayerAnimationInfo = requestPlayerAnimationInfo;
	}

	public RequestPlayerAnimationInfoRequest(int receiveMessageId, InputStream is, int contentLength, ISender sender, String sessionId, REQUEST_PLAYER_ANIMATION_INFO requestPlayerAnimationInfo) throws Exception {
