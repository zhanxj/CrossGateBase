 ...
 * @author fuhuiyuan
 */
public class RequestChatRequest extends ProtoRequest {

	private REQUEST_CHAT requestChat;

	public RequestChatRequest(int receiveMessageId, byte[] datas, ISender sender, String sessionId, REQUEST_CHAT requestChat) {
		super(receiveMessageId, datas, sender, sessionId);
		this.requestChat = requestChat;
	}

	public RequestChatRequest(int receiveMessageId, InputStream is, int contentLength, ISender sender, String sessionId, REQUEST_CHAT requestChat) throws Exception {
