 ...
 * @author fuhuiyuan
 */
public class RequestPlayerCreateRequest extends ProtoRequest {

	private REQUEST_PLAYER_CREATE requestPlayerCreate;

	public RequestPlayerCreateRequest(int receiveMessageId, byte[] datas, ISender sender, String sessionId, REQUEST_PLAYER_CREATE requestPlayerCreate) {
		super(receiveMessageId, datas, sender, sessionId);
		this.requestPlayerCreate = requestPlayerCreate;
	}

	public RequestPlayerCreateRequest(int receiveMessageId, InputStream is, int contentLength, ISender sender, String sessionId, REQUEST_PLAYER_CREATE requestPlayerCreate) throws Exception {
