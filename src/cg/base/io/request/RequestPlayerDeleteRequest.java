 ...
 * @author fuhuiyuan
 */
public class RequestPlayerDeleteRequest extends ProtoRequest {

	private REQUEST_PLAYER_DELETE requestPlayerDelete;

	public RequestPlayerDeleteRequest(int receiveMessageId, byte[] datas, ISender sender, String sessionId, REQUEST_PLAYER_DELETE requestPlayerDelete) {
		super(receiveMessageId, datas, sender, sessionId);
		this.requestPlayerDelete = requestPlayerDelete;
	}

	public RequestPlayerDeleteRequest(int receiveMessageId, InputStream is, int contentLength, ISender sender, String sessionId, REQUEST_PLAYER_DELETE requestPlayerDelete) throws Exception {
