 ...
 * @author fuhuiyuan
 */
public class RequestPlayerLogin extends ProtoRequest {

	private REQUEST_PLAYER_LOGIN requestPlayerLogin;

	public RequestPlayerLogin(int receiveMessageId, byte[] datas, ISender sender, String sessionId, REQUEST_PLAYER_LOGIN requestPlayerLogin) {
		super(receiveMessageId, datas, sender, sessionId);
		this.requestPlayerLogin = requestPlayerLogin;
	}

	public RequestPlayerLogin(int receiveMessageId, InputStream is, int contentLength, ISender sender, String sessionId, REQUEST_PLAYER_LOGIN requestPlayerLogin) throws Exception {
