 ...
 * @author fuhuiyuan
 */
public class RequestAccountRegisterRequest extends ProtoRequest {

	private REQUEST_ACCOUNT_REGISTER requestAccountRegister;

	public RequestAccountRegisterRequest(int receiveMessageId, byte[] datas, ISender sender, String sessionId, REQUEST_ACCOUNT_REGISTER requestAccountRegister) {
		super(receiveMessageId, datas, sender, sessionId);
		this.requestAccountRegister = requestAccountRegister;
	}

	public RequestAccountRegisterRequest(int receiveMessageId, InputStream is, int contentLength, ISender sender, String sessionId, REQUEST_ACCOUNT_REGISTER requestAccountRegister) throws Exception {
