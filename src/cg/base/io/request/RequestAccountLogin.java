 ...
 * @author fuhuiyuan
 */
public class RequestAccountLogin extends ProtoRequest {

	private REQUEST_ACCOUNT_LOGIN requestAccountLogin;

	public RequestAccountLogin(int receiveMessageId, byte[] datas, ISender sender, String sessionId, REQUEST_ACCOUNT_LOGIN requestAccountLogin) {
		super(receiveMessageId, datas, sender, sessionId);
		this.requestAccountLogin = requestAccountLogin;
	}

	public RequestAccountLogin(int receiveMessageId, InputStream is, int contentLength, ISender sender, String sessionId, REQUEST_ACCOUNT_LOGIN requestAccountLogin) throws Exception {
