 ...
 * @author fuhuiyuan
 */
public class RequestOptionsSet extends ProtoRequest {

	private REQUEST_OPTIONS_SET requestOptionsSet;

	public RequestOptionsSet(int receiveMessageId, byte[] datas, ISender sender, String sessionId, REQUEST_OPTIONS_SET requestOptionsSet) {
		super(receiveMessageId, datas, sender, sessionId);
		this.requestOptionsSet = requestOptionsSet;
	}

	public RequestOptionsSet(int receiveMessageId, InputStream is, int contentLength, ISender sender, String sessionId, REQUEST_OPTIONS_SET requestOptionsSet) throws Exception {
