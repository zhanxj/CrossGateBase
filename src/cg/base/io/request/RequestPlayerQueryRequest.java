 ...
 * @author fuhuiyuan
 */
public class RequestPlayerQueryRequest extends ProtoRequest {

	private REQUEST_PLAYER_QUERY requestPlayerQuery;

	public RequestPlayerQueryRequest(int receiveMessageId, byte[] datas, ISender sender, String sessionId, REQUEST_PLAYER_QUERY requestPlayerQuery) {
		super(receiveMessageId, datas, sender, sessionId);
		this.requestPlayerQuery = requestPlayerQuery;
	}

	public RequestPlayerQueryRequest(int receiveMessageId, InputStream is, int contentLength, ISender sender, String sessionId, REQUEST_PLAYER_QUERY requestPlayerQuery) throws Exception {
