 ...
 * @author fuhuiyuan
 */
public class RequestMapIn extends ProtoRequest {

	private REQUEST_MAP_IN requestMapIn;

	public RequestMapIn(int receiveMessageId, byte[] datas, ISender sender, String sessionId, REQUEST_MAP_IN requestMapIn) {
		super(receiveMessageId, datas, sender, sessionId);
		this.requestMapIn = requestMapIn;
	}

	public RequestMapIn(int receiveMessageId, InputStream is, int contentLength, ISender sender, String sessionId, REQUEST_MAP_IN requestMapIn) throws Exception {
