 ...
 * @author fuhuiyuan
 */
public class RequestServerSelect extends ProtoRequest {

	private REQUEST_SERVER_SELECT requestServerSelect;

	public RequestServerSelect(int receiveMessageId, byte[] datas, ISender sender, String sessionId, REQUEST_SERVER_SELECT requestServerSelect) {
		super(receiveMessageId, datas, sender, sessionId);
		this.requestServerSelect = requestServerSelect;
	}

	public RequestServerSelect(int receiveMessageId, InputStream is, int contentLength, ISender sender, String sessionId, REQUEST_SERVER_SELECT requestServerSelect) throws Exception {
