 ...
 * @author fuhuiyuan
 */
public class RequestBattleAttack extends ProtoRequest {

	private REQUEST_BATTLE_ATTACK requestBattleAttack;

	public RequestBattleAttack(int receiveMessageId, byte[] datas, ISender sender, String sessionId, REQUEST_BATTLE_ATTACK requestBattleAttack) {
		super(receiveMessageId, datas, sender, sessionId);
		this.requestBattleAttack = requestBattleAttack;
	}

	public RequestBattleAttack(int receiveMessageId, InputStream is, int contentLength, ISender sender, String sessionId, REQUEST_BATTLE_ATTACK requestBattleAttack) throws Exception {
